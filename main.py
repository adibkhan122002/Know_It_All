...
class Main(object):
    def __init__(self, master):
        ...
        self.title_right = Label(image_bar, text='Know It All', font='arial 16 bold')
        self.title_right.grid(row=0)
        self.image_library = PhotoImage(file='icons\\know.png')
        ...
        self.icon_noti = PhotoImage(file='icons\\email1.png')
        self.btnnoti = Button(topFrame, text='Email Notification', font='arial 12 bold', padx=10, image=self.icon_noti, compound=LEFT, command=notification())
        self.btnnoti.pack(side=LEFT)
...
class GiveBook(Toplevel):
    def __init__(self):
        ...
        query2 = "SELECT member_name FROM members"
        ...
        self.lbl_date = Label(self.bottomFrame, text='Date :', font='arial 15 bold', fg='white',
                                  bg='#fcc324')
        self.lbl_date.place(x=40, y=120)
        self.date_picker = DateEntry(self.bottomFrame, date_pattern='yyyy-mm-dd',textvariable=self.date_var)
        self.date_picker.place(x=195, y=125)
        # Button
    ...
    def lendBook(self):
        ...
        return_date = self.date_entry.get()

        if (book_name and member_name != ""):
            try:
                query = "INSERT INTO 'borrows'(bbook_id,bmember_id,return_date) VALUES(?,?,?)"
                cur.execute(query, (book_name, member_name,return_date))
                con.commit()
